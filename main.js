...
// function filtereyeColour() {
//     let eyeColours = [];
//     for (let user of users) {
//         if (user.eyeColor.toLocaleLowerCase() == "green") {
//             eyeColours.push(user)
//         }
//     }
//     return eyeColours
// }
// let result = filtereyeColour()
// console.log("goz rengi yasil olanlar:", result);
...
//         if(index.address.city=="San Francisco"){
//             cities.push(index)
//             console.log("San Francisco olan arraylar", index);
...
// function filterDepartament(){
//     let enginierDepartament =[];
//     for(let index of users){
//         if(index.company.department=="Engineering"){
//             enginierDepartament.push(index);
//         }
//     }
//     return enginierDepartament;
// }

// let result =filterDepartament();
// console.log("Departamenti Engineering olan:", result);
...
// }
// let result= genders();
// console.log("Cins male:", result.male);
// console.log("Cins female:", result.female);


// ! yaza bilmedim5) 4 cu taskdaki arraydeki male ve ya famele olan arrayden her hansisa elementi silen function yazin 


// function genders(users){
//     let index =0;
//     for(let person of users){
//         if(person.gender =="male"){
//             users.splice(index, 1,3,5,6,8,19,30)
//             break
//         }
//         index++
//     }
